...
//
//        startTime = System.currentTimeMillis();
//        results = StatsAccumulator.calcStatsWithParallelCollector(admissionCompanies);
//        endTime = System.currentTimeMillis();
//        printResults("Parallel Collector",  results, endTime - startTime);
//
//        startTime = System.currentTimeMillis();
//        results = StatsAccumulator.calcStatsWithParallelCollector(admissionCompanies, DELAY);
//        endTime = System.currentTimeMillis();
//        printResults("Parallel Collector with delay",  results, endTime - startTime);
